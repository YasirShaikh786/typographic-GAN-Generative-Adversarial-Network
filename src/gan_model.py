...
class SimpleGlyphGAN:
    ...
    def sample_images(self, epoch):
        ...
        # Save images using the utility function
    ...
    def save_models(self, epoch):
        ...
        self.combined.save(f"models/combined_{epoch}.h5")
    
    def load_models(self, epoch):
        from tensorflow.keras.models import load_model
        self.generator = load_model(f"models/generator_{epoch}.h5")
        self.discriminator = load_model(f"models/discriminator_{epoch}.h5")
        self.combined = load_model(f"models/combined_{epoch}.h5")